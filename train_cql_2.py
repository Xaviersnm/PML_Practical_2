...
def cql_eval(env, config, q_table, eval_episodes=100, output=True):
    """
    Evaluation loop specific to CQL (Single Joint Q-Table)
    """
    eval_agents = CQL(
...
if __name__ == "__main__":
    ...
    # Task 1: Competitive
    print(">>> RUNNING TASK 1A: COMPETITIVE CQL")
    ...
    record_video(
        ...
        trained_agents_comp, 
        CONFIG, 
        filename="cql_competitive.gif"
    )
    visualise_evaluation_returns(means_comp, stds_comp)

    # Task 1: Cooperative
    print("\n>>> RUNNING TASK 1B: COOPERATIVE CQL")
